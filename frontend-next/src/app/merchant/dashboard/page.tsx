...
export default function MerchantDashboard() {
        ...
        const fetchStats = async () => {
            ...
            try {
                ...
                setStats({
                    ...
                    // Payment status fields from API
    ...
    // Dynamic payment status message based on credit/overdue balance
    const getPaymentStatusMessage = (paymentStatus: string, overdueDays: number, overdueBalance: number, creditBalance: number) => {
